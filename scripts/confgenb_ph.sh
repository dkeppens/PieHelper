...
while getopts v:h PH_OPTION 2>/dev/null
do
	case $PH_OPTION in v)
...
EOF
	...
	cd $PH_SCRIPTS_DIR/../.. ; tar -X $PH_FILES_DIR/exclude -cvf $PH_BUILD_DIR/PieHelper-$PH_NEW_VERSION.tar ./PieHelper >/dev/null 2>&1 || \
