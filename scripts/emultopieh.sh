#!/bin/ksh
# Move from Emulationstation to PieHelper (by Davy Keppens on 04/10/2018)
# Enable/Disable debug by running confpieh_ph.sh -d emultopieh.sh
...
do
        case $PH_OPTION in *)
                ...
                >&2 printf "%9s%s\n" "" "If successful, a new instance of PieHelper will be started if one is not already running"
                >&2 printf "\n"
