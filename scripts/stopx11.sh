#!/bin/ksh
# Stop X11 (by Davy Keppens on 04/10/2018)
# Enable/Disable debug by running confpieh_ph.sh -d stopx11.sh
...
do
        case $PH_OPTION in *)
                ...
                >&2 printf "%9s%s\n" "" "- Running this script without parameters will stop an instance of X11 running on it's allocated TTY"
                >&2 printf "\n"
