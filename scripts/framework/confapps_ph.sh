...
do
	case "${PH_OPTION}" in r)
		...
		>&2 printf "%29s%s\n" "" "- Applications with a maximum state of Supported or applications with an active or non-empty mounpoint will be skipped"
		...
		>&2 printf "%29s%s\n" "" "- The mountpoint is defined by the value of option 'PH_[APPU]_CIFS_MPT' where [APPU] is"
		>&2 printf "%29s%s\n" "" "  the first four characters of the selected application's name in uppercase"
		>&2 printf "%29s%s\n" "" "- Applications with a maximum state of Supported or applications with an active or non-empty mountpoint will be skipped"
