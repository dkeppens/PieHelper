#!/bin/ksh
# Move from Moonlight to Emulationstation (by Davy Keppens on 04/10/2018)
# Enable/Disable debug by running confpieh_ph.sh -p debug -m moontoemul.sh
